...
|----------------------------------------------------------------------------|--------------------------------------|
| <sup>Тетрис в режиме запуска в текущей оболочке по комбинации клавиш</sup> | <sup>Случайный кадр из игры</sup>    |
...
```
  строк кода -------------- 1004
  объём кода -------------- 66168 символов
  контрольная сумма MD5 --- 4d76501a58663f115d848e19d401cfc4
```
