...
[Ссылка](retro/btet) на мой экземпляр BackGround Tetris, который храню уже более 30 лет: <br/>
Публичная [ссылка](http://old-dos.ru/index.php?page=files&mode=games&do=show&id=3067) на BackGround Tetris. <br/>
...
Моя работа к конкурсу доступна по [ссылке](retro/SofTool`94).<br/>
<br/>
![Александр Яковлев (слева) и Александр Липатов (справа), предположительно на выпускном вечере (1993 год)](images/yakovlev_alex (left), lipatov_alex (right), ~1993 year.png)
![Александр Липатов, предположительно 1994 год](images/lipatov_alex, ~1994 year.png)
